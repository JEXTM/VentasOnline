 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = "com.webstotales.ventasOnline")
...
public class JpaConfig implements DisposableBean{
	...
	// private static final String PROPERTY_NAME_DATABASE_URL = "jdbc:mysql://mysql20912-jextm0424.jl.serv.net.mx/ventasOnline";
	 ...
	 private static final String PROPERTY_NAME_DATABASE_PASSWORD = "jextm";
	    ...
	    public LocalContainerEntityManagerFactoryBean entityManagerFactory(){
	        ...
	        lcemfb.setPackagesToScan(new String[] {"com.webstotales.ventasOnline"});
